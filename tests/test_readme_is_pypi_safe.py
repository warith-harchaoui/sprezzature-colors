...
``pypi.org/project/sprezzature-colors/EXAMPLES.md``, a 404, and a relative image
...
def test_readme_targets_are_absolute() -> None:
    ...
    assert not relative, (
        ...
        "Point these at https://github.com/warith-harchaoui/sprezzature-colors/blob/main/… "
        "instead:\n  " + "\n  ".join(relative)
    )
